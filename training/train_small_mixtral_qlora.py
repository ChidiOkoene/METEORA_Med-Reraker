#!/usr/bin/env python3
r"""
training/train_mistral_small_qlora.py

Downloads Mistral-Small-3.2-24B model to D: drive and trains LoRA adapters using QLoORA.
...
# ---------------- UPDATED PATHS FOR MISTRAL-SMALL ----------------
LOCAL_MODEL_PATH = r"D:\models\Mistral-7B-Instruct-v0.2"
MODEL_NAME = "mistralai/Mistral-7B-Instruct-v0.2"  # Change to the correct model repo if needed
...
OUTPUT_DIR = r"D:\projects\meteora_project\outputs\lora_out_mistral_small"
OFFLOAD_DIR = r"D:\offload"  # Directory for any offloading operations

# Keep your existing hyperparameters
...
logger = logging.getLogger("train_mistral_small_qlora")
...
def download_model_if_needed():
    ...
    if not os.path.exists(LOCAL_MODEL_PATH):
        ...
        try:
            snapshot_download(
                "mistralai/Mistral-7B-Instruct-v0.2",  # Change to the correct model repo if needed
